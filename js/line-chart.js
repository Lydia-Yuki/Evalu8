...
let myChart = new Chart(ctx, {
 ...
 var getSelectedRow = function(val)
    {
        db.transaction(function(transaction) {
              transaction.executeSql('SELECT * FROM eval where points = parseInt(val);',[], selectedRowValues, errorHandler);

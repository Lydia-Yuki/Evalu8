								...
								<table class="table" width='250px'>
                                  ...
                                  <tbody>
                                        <?php 
                                            include ('config.php');
                                            // session_start();
                                            $sel = 'SELECT * FROM students s, eval e WHERE class="3 North" AND s.stud_id=e.stud_id';
...
if(isset($_POST['add'])){
    ...
    $sel = "INSERT INTO otable(sub, day, hour, min, sechr, secmin, class) VALUES ('$Sub', '$Day', '$Hour', '$Min','$Sechr', '$Secmin', '3 North')";
...
<script src="ttable/timetable.js" type="text/javascript"></script>
    <script>
        ...
        <?php $que = "SELECT * FROM otable WHERE class='3 North'";

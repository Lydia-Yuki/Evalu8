                        ...
                        <div class="content">
                            ...
                            <div class="btn-box-row row-fluid">
                                    <div class="span8">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="info.php" class="btn-box small span4"><i class="icon-envelope"></i><b>Student Information</b>
                                                </a><a href="class.php" class="btn-box small span4"><i class="icon-group"></i><b>Classes</b>
                                                </a><a href="eval.php" class="btn-box small span4"><i class="icon-exchange"></i><b>Evaluation by Form</b>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="teacher.php" class="btn-box small span4"><i class="icon-user"></i><b>Teachers</b>
                                                </a><a href="schedule.php" class="btn-box small span4"><i class="icon-calendar"></i><b>A level Schedule</b></a>
                                            </div>
                                        </div>
                                    </div>
                            </div>

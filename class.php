                        ...
                        <div class="content">
                            ...
                            <div class="btn-box-row row-fluid">
                                    <div class="span8">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="1north.php" class="btn-box small span4"><i class="icon-group"></i><b>1 North</b>
                                                </a><a href="1east.php" class="btn-box small span4"><i class="icon-group"></i><b>1 East</b>
                                                </a><a href="1south.php" class="btn-box small span4"><i class="icon-group"></i><b>1 South</b>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="2north.php" class="btn-box small span4"><i class="icon-group"></i><b>2 North</b>
                                                </a><a href="2east.php" class="btn-box small span4"><i class="icon-group"></i><b>2 East</b>
                                                </a><a href="2south.php" class="btn-box small span4"><i class="icon-group"></i><b>2 South</b> </a>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="3north.php" class="btn-box small span4"><i class="icon-group"></i><b>3 North</b>
                                                </a><a href="3east.php" class="btn-box small span4"><i class="icon-group"></i><b>3 East</b>
                                                </a><a href="3south.php" class="btn-box small span4"><i class="icon-group"></i><b>3 South</b> </a>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="4north.php" class="btn-box small span4"><i class="icon-group"></i><b>4 North</b>
                                                </a><a href="4east.php" class="btn-box small span4"><i class="icon-group"></i><b>4 East</b>
                                                </a><a href="4south.php" class="btn-box small span4"><i class="icon-group"></i><b>4 South</b> </a>
                                            </div>
                                        </div>
                                    </div>
                            </div>
